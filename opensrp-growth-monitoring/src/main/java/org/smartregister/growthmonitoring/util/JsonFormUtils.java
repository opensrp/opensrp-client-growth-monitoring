...
public class JsonFormUtils extends org.smartregister.util.JsonFormUtils {
    ...
    public static void createHeightEvent(Context context, Height weight, String eventType, String entityType, JSONArray fields) {
        try {
            EventClientRepository db = GrowthMonitoringLibrary.getInstance().eventClientRepository();
    ...
    public static void createMuacEvent(Context context, MUAC weight, String eventType, String entityType, JSONArray fields) {
        try {
            EventClientRepository db = GrowthMonitoringLibrary.getInstance().eventClientRepository();
