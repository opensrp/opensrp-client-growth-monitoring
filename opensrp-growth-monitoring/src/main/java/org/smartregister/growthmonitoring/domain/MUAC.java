...
public class MUAC {
    ...
    public MUAC(Long id, String baseEntityId, Float cm, Date date, String anmId, String
    ...
    public MUAC(Long id, String baseEntityId, String programClientId, Float cm, Date date,
